<template>
    <div class="app-container">
      ...
      <el-table v-loading="loading" :data="reportList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="员工名" align="center" prop="userName" />
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button size="mini" type="text" icon="el-icon-view" @click="handleUpdate(scope.row)"
              v-hasPermi="['project:report:edit']">查看</el-button>
          </template>
        </el-table-column>
      </el-table>
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="120px">
          ...
          <el-form-item label="本周工作内容">
            <el-table :data="contentTable" style="width: 100%">
              ...
              <el-table-column prop="workContent" label="工作内容" align="center" width="550">
                <template slot-scope="scope">
          ...
          <el-form-item label="下周工作计划">
            <el-table :data="planTable" style="width: 100%">
              <el-table-column prop="workContent" label="工作计划" align="center" width="550">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.content" clearable></el-input>
                </template>
              </el-table-column>
          ...
          <el-form-item label="目前存在问题">
            <el-table :data="problemTable" style="width: 100%">
              <el-table-column prop="workContent" label="存在问题" align="center" width="550">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.content" clearable></el-input>
                </template>
              </el-table-column>
      ...
      handleUpdate(row) {
        ...
        getReport(weekrId).then(response => {
          ...
          if( this.form.weekContent != null && this.form.weekContent != undefined) {
            // let str1 = this.form.weekProname.split("^");
            // let str2 = this.form.weekPercent.split("^");
            let str3 = this.form.weekContent.split("^");
            var param = {};
            for(var i = 0;i<str3.length;i++) {
              // param.proName = str1[i];
              param.content = str3[i];
